![Click2Install Logo](http://click2install.com.au/img/logo.png)

Blockchain Explorer &middot;
![GitHub license](https://img.shields.io/github/license/click2install/blockchain-explorer.svg)
=========

Simple cryptocurrency block explorer system, based on the [Bulwark Block Explorer](https://github.com/bulwark-crypto/bulwark-explorer).

## Install
`git clone https://github.com/click2install/blockchain-explorer.git` - copy repo to local folder.
